...
tidy_fit$term <- recode(tidy_fit$term, `genotype.L` = "K04F10S", `genotype.Q` = "pbs1") 
...
summary(lm(width~genotype, mean_cleanrawsmorph))
...
summary(lm(kink~genotype, mean_cleanrawsmorph))
...
summary(lm(speed~genotype, mean_cleanrawsmorph_posthab))
...
summary(lm(final_rev_prob~genotype, Final_rev_prob))
...
summary(lm(final_rev_dur~genotype, Final_rev_dur))
...
summary(lm(final_rev_speed~genotype, Final_rev_speed))


summary(aov(final_rev_prob~genotype, Final_rev_prob))
